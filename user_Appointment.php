    ...
    <div class="row">
        ...
        <?php if ($formStep === 'step1') { ?>
                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    ...
                    <label>Full Name:
                        <input type="text" name="fname" placeholder="First name" class="box" value="<?php echo $_POST['name'] ?? ''; ?>" required><input type="text" name="lname" placeholder="Last name" class="box" value="<?php echo $_POST['name'] ?? ''; ?>" required></label>
                    <label>N.I.C:
                        <input type="text" name="nic" placeholder="your NIC" class="box" value="<?php echo $_POST['nic'] ?? ''; ?>" required></label>
                    <label>Birthday:
                        <input type="date" name="bd" placeholder="Your Birthday" class="box" value="<?php echo $_POST['bd'] ?? ''; ?>" required></label>
                    <label>Phone No:
                        <input type="text" name="number" placeholder="your Phone-number" class="box" value="<?php echo $_POST['pnumber'] ?? ''; ?>" required></label>
                    <label>Email:
                    <input type="email" name="email" placeholder="your email" class="box" value="<?php echo $_POST['email'] ?? ''; ?>" required></label>
        ...
        <?php if ($formStep === 'step2') { ?>
                <form action="user_AppointmentPay.php" method="post">
                  ...
                  <label>Appointment Date:
                      <input type="date" name="appointDate" id="date_picker" placeholder="appointment date" class="box" required></label>
